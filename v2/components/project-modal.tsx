...
import { ExternalLink, Github, CheckCircle, Lightbulb, Code2, Users, Maximize2, X } from "lucide-react"
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {project.links.live && (
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700 cursor-pointer" asChild>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {primaryTechGroups.map(([groupName, techs]) => (
                  <div key={groupName}>
                    <h5 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">{groupName}</h5>
                    <div className="flex flex-wrap gap-2">
                      {techs.map((tech) => (
                        <Badge key={tech} variant="outline" className="px-2 py-1 text-xs">
                          {techIcons[tech as keyof typeof techIcons] && (
                            <span className="mr-1">{techIcons[tech as keyof typeof techIcons]}</span>
                          )}
                          {tech}
                        </Badge>
                      ))}
                  ...
                  <CardContent className="pt-3 pb-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {feature.myContribution && (
                        <Badge className="bg-blue-500 text-white text-xs">My Contribution</Badge>
                      )}
                    </div>
            ...
            <div>
              ...
              <Card className="border-0 shadow-sm bg-yellow-50/50 dark:bg-yellow-900/10">
                ...
                <CardContent className="space-y-3">
                  <div>
                    <h4 className="text-xs font-semibold text-gray-900 dark:text-white mb-1">Challenge:</h4>
                    <p className="text-xs text-gray-700 dark:text-gray-300">{project.troubleshoots[0].problem}</p>
                  </div>
                  <div>
                    <h4 className="text-xs font-semibold text-gray-900 dark:text-white mb-1">Solution:</h4>
                    <p className="text-xs text-gray-700 dark:text-gray-300">{project.troubleshoots[0].solution}</p>
                  </div>
                </CardContent>
              </Card>
            </div>
