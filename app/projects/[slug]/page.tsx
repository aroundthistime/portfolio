...
import { ArrowLeft, ExternalLink, Github, Globe, CheckCircle, Lightbulb, Code2, Users } from "lucide-react"
...
const projectsData = {
  "ecommerce-platform": {
    ...
    techSkillsUsed: ["Next.js 14", "TypeScript", "Tailwind CSS", "Stripe API", "PostgreSQL", "Redis"],
...
The project took 8 months to complete with a team of 6 developers. I was responsible for the entire frontend architecture, component library design, and performance optimization strategies.`,
    features: [
      {
        ...
        description: "Advanced filtering, sorting, and search with Elasticsearch integration",
        myContribution: true,
      },
      {
        name: "Shopping Cart & Checkout",
        description: "Multi-step checkout process with guest and registered user support",
        myContribution: true,
      },
      {
        name: "Payment Processing",
        description: "Stripe integration with support for multiple payment methods",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "Comprehensive admin interface for product and order management",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "Sales analytics, user behavior tracking, and custom reports",
        myContribution: false,
      },
      {
  ...
  "task-management-app": {
    ...
    image: "/placeholder.svg?height=400&width=800",
    techSkillsUsed: ["React 18", "TypeScript", "Socket.io", "React Query", "Framer Motion", "Styled Components"],
...
I also implemented advanced features like bulk operations, keyboard shortcuts, and offline support with conflict resolution. The application needed to work seamlessly across different devices and screen sizes, which required careful consideration of responsive design patterns.`,
    features: [
      ...
      },
      {
        ...
        description: "Live updates, user presence indicators, and conflict resolution",
        myContribution: true,
      },
      {
        name: "Multiple Project Views",
        description: "Kanban, List, Calendar, and Gantt chart views for different workflows",
        myContribution: true,
      },
      {
        name: "Advanced Filtering & Search",
        description: "Complex filtering options with saved filters and search across all content",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "Customizable project templates for different team workflows",
        myContribution: false,
      },
      {
        name: "Time Tracking",
      ...
      },
      {
        ...
        description: "Integrations with Slack, GitHub, and other development tools",
        myContribution: false,
      },
    ],
    troubleshoots: [
  ...
  "analytics-dashboard": {
    ...
    image: "/placeholder.svg?height=400&width=800",
    techSkillsUsed: ["React", "D3.js", "TypeScript", "React Query", "Recharts", "Date-fns"],
...
Key technical achievements included building a custom chart library on top of D3.js for specific business requirements, implementing efficient data aggregation on the frontend, and creating a responsive design that worked well on both desktop and tablet devices.`,
    features: [
      {
        ...
        description: "Custom charts, graphs, and heatmaps with drill-down capabilities",
        myContribution: true,
      },
      {
        name: "Real-time Data Updates",
        description: "Live data streaming with WebSocket integration and automatic refresh",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "Complex multi-dimensional filtering with date ranges and custom segments",
        myContribution: true,
      },
      {
        name: "Export and Sharing",
        description: "PDF/CSV export functionality and shareable dashboard links",
        myContribution: true,
      },
      {
  ...
  "mobile-banking-app": {
    ...
    techSkillsExposed: ["OAuth 2.0", "Biometric APIs", "Push Notifications", "SSL/TLS"],
    ...
    features: [
      {
        ...
        description: "Comprehensive overview of accounts, balances, and recent transactions",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "Budget tracking, spending analysis, and savings goal management",
        myContribution: true,
      },
      {
      ...
      },
      {
        ...
        description: "GDPR, PCI DSS, and banking regulation compliance features",
        myContribution: false,
      },
    ],
    troubleshoots: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {project.links.github && project.links.github !== "Private Repository" && (
                <Button variant="outline" size="sm" asChild className="cursor-pointer bg-transparent">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {groupTechnologies(project.techSkillsUsed).map(([groupName, techs]) => (
                <div key={groupName}>
                  <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">{groupName}</h4>
                  <div className="flex flex-wrap gap-3">
                    {techs.map((tech) => (
                      <Badge key={tech} variant="outline" className="px-3 py-1 text-sm">
                        {techIcons[tech as keyof typeof techIcons] && (
                          <span className="mr-2">{techIcons[tech as keyof typeof techIcons]}</span>
                        )}
                        {tech}
                      </Badge>
                    ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              {groupTechnologies(project.techSkillsExposed).map(([groupName, techs]) => (
                <div key={groupName}>
                  <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">{groupName}</h4>
                  <div className="flex flex-wrap gap-3">
                    {techs.map((tech) => (
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Project Overview & My Contributions</h2>
          <Card className="border-0 shadow-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
            <CardContent className="pt-6">
              <div className="prose max-w-none">
                {project.detailedExplanation.split("\n\n").map((paragraph, index) => (
              ...
              >
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-base text-gray-900 dark:text-white">{feature.name}</CardTitle>
                    {feature.myContribution && (
                      <Badge className="bg-blue-500 text-white hover:bg-blue-600 text-xs">My Contribution</Badge>
                    )}
                  </div>
                </CardHeader>
                <CardContent>
              ...
              <Card key={index} className="border-0 shadow-lg bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{item.problem}</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">My Solution:</h4>
